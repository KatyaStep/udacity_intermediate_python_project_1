...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return (
            ...
            f" and {_is} potentially hazardous "
        )
...
class CloseApproach:
    ...
    def __init__(self, designation, time, distance=0.0, velocity=0.0):
        ...
        self.time = cd_to_datetime(time)  # Used the cd_to_datetime function.
        self.distance = float(distance) if distance else 0.0
        self.velocity = float(velocity) if velocity else 0.0

        # an attribute for the referenced NEO, originally None.
        self.neo = None
    ...
    def __str__(self):
        ...
        # a human-readable string representation.
        return (
            f"On {self.time_str} {self._designation} ({self.neo}) approaches Earth at "
